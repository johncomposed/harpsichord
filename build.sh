...
git push && git subtree push --prefix www origin gh-pages # Pushing compiled site to gh-pages
git checkout gh-pages && git pull                         # Pulling site changes to local
git checkout gh-pages-dev && git pull                     # Pulling dev changes to local
